...
public class DBScan{
    ...
    private List<Point3D> list_point3D;
    private NearestNeighborsKD n1;
    ...
    public DBScan(ArrayList<Point3D> list){
        list_point3D = list;
        n1 = new NearestNeighborsKD(list_point3D);
        n2 = new NearestNeighborsKD(list_point3D);
        stack = new MyStack();
    }
    ...
    public void findClusters(){
        ...
        for (Point3D p : list_point3D){
            ...
            List<Point3D> N = n1.rangeQuery(p, Eps);         /* Find neighbors */
            ...
            while (!stack.isEmpty()) {
                ...
                List<Point3D> N2 = n2.rangeQuery(Q, Eps);   /* Find neighbors */
